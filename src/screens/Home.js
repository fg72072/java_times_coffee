...
import {Banner, Second,CardOne, CardTwo, CardThree, Background, Bolsa, TONINHO, Coffee} from '../components/Images'
function Home()
{
    return <>
    <div className="banner-section">
        <div className='banner-inner'>
        <h1 className='banner-text absolute-text'>Coffee to the max.</h1>
        </div>
    </div>
    <section>
        ...
        <Container>
            <Row>
                ...
                <Col lg={4} sm={12} md={4}>
                    ...
                    <div className='position-relative'>
                    <span>NEW!</span>
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="60.787 56.795 478.427 478.412" xmlns="http://www.w3.org/2000/svg" viewBox="60.787 56.795 478.427 478.412" role="presentation" aria-hidden="true">
                        <g>
            ...
            <div className='text-center'>
            <Link to={"#"} className="btn primary-btn">SEE MENU</Link>
            </div>
        </Container>
    </section>
    <section className='section'>
        <div className='section2'>
            ...
            <h3 className='common-heading text-white'>BRING THE BEST COFFEE HOME.</h3>
            </div>
                <Row>
                <Col lg={4} sm={12} md={4}>
                    <article className='custom-card-two'>
                    <img src={Bolsa}/>
                    <h3>JTC™ HOUSE BLEND <br/>500 G.</h3>
                    </article>
                </Col>
                <Col lg={4} sm={12} md={4}>
                    <article className='custom-card-two'>
                ...
                <Link to={"#"} className="btn primary-btn">SEE MORE</Link>
                </div>
            </Container>
        </div>
    </section>
        ...
        <Container fluid>
            <Row className='col-without-padding'>
                <Col lg={6} md={6}>
                    ...
                    <h4 className='secondary-text'>A dream made for everyone to enjoy.</h4>
                    <p>In Mexico it saw its beginnings in 1999 in the city of Torreón Coahuila as a coffee roasting company and distributor of supplies and equipment for the industry, with coverage for the entire Mexican Republic, always with the support of sister companies in the United States. At the end of the same year, the first Java Times Caffé coffee shop opened, located in the Galerías Laguna shopping center in the city of Torreón.</p>
                    <Link to={"#"} className="btn primary-btn">SEE MORE</Link>
                ...
                <Col lg={6} md={6}>
                    ...
                    <p>Paragraph. Click here to add your own text and edit. It is easy. Click Edit Text or double click here to add your content and change the font. You can drag and drop this text wherever you want on your page. Here you can tell your story and let your users know more about you.</p>
                    <Link to={"#"} className="btn primary-btn">PURCHASE</Link>
        ...
        <div class="background-text">
          <div className='bottom-div'>
              <h2 className='banner-text'>CONTENT HEADING HERE</h2>
                <p>Enjoy the best coffee, the richest pastries, the most delicious sandwiches <br/>
